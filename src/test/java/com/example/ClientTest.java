...
public class ClientTest {
  ...
  @Test
  public void testToCardiac() {
    assertEquals("Cardiac Medical", Client.getShiftName(2));
  }
  ...
  @Test
  void testInvalidChoiceMessage() {
    String expectedMessage = "Invalid choice. Please select a valid option (1-4).";
    assertEquals(expectedMessage, Client.handleInvalidChoice(5));
  }
